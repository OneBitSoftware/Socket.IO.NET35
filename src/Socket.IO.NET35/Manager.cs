...
namespace Socket.IO.NET35
{
    public class Manager : Emitter
    {
        ...
        private SocketEngine.Options Options;
        ...
        public SocketEngine EngineSocket;
        ...
        private void OnOpen()
        {
            ...
            sub = SOCKETNET35.On.Create(this.Decoder, Parser.Decoder.EVENT_DECODED, new ListenerImpl((data) =>
            {
            ...
            sub = SOCKETNET35.On.Create(socket, EVENT_ERROR, new ListenerImpl((data) =>
            {
            ...
            sub = SOCKETNET35.On.Create(socket, EVENT_CLOSE, new ListenerImpl((data) =>
            {
                OnClose((string)data);
            }));
        ...
        public Socket Socket(string nsp)
        {
            ...
            socket.On(SOCKETNET35.Socket.EVENT_CONNECT, new ListenerImpl(() =>
            {
                Connected++;
            }));
            return socket;
        ...
        private void ProcessPacketQueue()
        {
            ...
            {
                Packet pack = this.PacketBuffer[0];
    ...
    public class Engine : SocketEngine
    {
    ...
    public class ManagerOptions : SocketEngine.Options
    {
        public bool Reconnection = true;
        public int ReconnectionAttempts = 3;
        public long ReconnectionDelay;
        public long ReconnectionDelayMax;
